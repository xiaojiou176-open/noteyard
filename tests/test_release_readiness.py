    ...
    remote_summary["pull_requests"] = [
        {
            ...
            "url": "https://github.com/xiaojiou176-open/notes-recover/pull/1",
        }
    ]
    ...
    remote_summary["pull_requests"] = [
        {
            ...
            "url": "https://github.com/xiaojiou176-open/notes-recover/pull/3",
        },
        {
            "number": 9,
            "state": "CLOSED",
            "title": "fix: allow github-hosted squash merge identity",
            "url": "https://github.com/xiaojiou176-open/notes-recover/pull/9",
        },
    ]
    ...
    remote_summary["pull_requests"] = [
        {
            ...
            "url": "https://github.com/xiaojiou176-open/notes-recover/pull/99",
        }
    ]
